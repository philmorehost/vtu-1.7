...
return [
    "up" => function($pdo) {
        ...
        $providers = [
            // Airtime
            ['name' => 'MTN', 'service_type' => 'airtime', 'code' => 'mtn'],
            ['name' => 'Airtel', 'service_type' => 'airtime', 'code' => 'airtel'],
            ['name' => 'GLO', 'service_type' => 'airtime', 'code' => 'glo'],
            ['name' => '9mobile', 'service_type' => 'airtime', 'code' => '9mobile'],
            // Bulk SMS
            ['name' => 'MTN', 'service_type' => 'bulksms', 'code' => 'mtn-sms'],
            ['name' => 'Airtel', 'service_type' => 'bulksms', 'code' => 'airtel-sms'],
            ['name' => 'GLO', 'service_type' => 'bulksms', 'code' => 'glo-sms'],
            ['name' => '9mobile', 'service_type' => 'bulksms', 'code' => '9mobile-sms'],
            // Data
            ['name' => 'SME', 'service_type' => 'data', 'code' => 'sme'],
            ['name' => 'SME2', 'service_type' => 'data', 'code' => 'sme2'],
            ['name' => 'CG-DATA', 'service_type' => 'data', 'code' => 'cg-data'],
            ['name' => 'DIRECT-DATA (DD)', 'service_type' => 'data', 'code' => 'direct-data'],
            ['name' => 'GIFTING', 'service_type' => 'data', 'code' => 'gifting'],
            // Cable TV
            ['name' => 'DSTV', 'service_type' => 'cabletv', 'code' => 'dstv'],
            ['name' => 'GOTV', 'service_type' => 'cabletv', 'code' => 'gotv'],
            ['name' => 'STARTIMES', 'service_type' => 'cabletv', 'code' => 'startimes'],
            ['name' => 'SHOWMAX', 'service_type' => 'cabletv', 'code' => 'showmax'],
            // Betting
            ['name' => 'msport', 'service_type' => 'betting', 'code' => 'msport'],
            ['name' => 'naijabet', 'service_type' => 'betting', 'code' => 'naijabet'],
            ['name' => 'nairabet', 'service_type' => 'betting', 'code' => 'nairabet'],
            ['name' => 'bet9ja-agent', 'service_type' => 'betting', 'code' => 'bet9ja-agent'],
            ['name' => 'betland', 'service_type' => 'betting', 'code' => 'betland'],
            ['name' => 'betlion', 'service_type' => 'betting', 'code' => 'betlion'],
            ['name' => 'supabet', 'service_type' => 'betting', 'code' => 'supabet'],
            ['name' => 'bet9ja', 'service_type' => 'betting', 'code' => 'bet9ja'],
            ['name' => 'bangbet', 'service_type' => 'betting', 'code' => 'bangbet'],
            ['name' => 'betking', 'service_type' => 'betting', 'code' => 'betking'],
            ['name' => '1xbet', 'service_type' => 'betting', 'code' => '1xbet'],
            ['name' => 'betway', 'service_type' => 'betting', 'code' => 'betway'],
            ['name' => 'merrybet', 'service_type' => 'betting', 'code' => 'merrybet'],
            ['name' => 'mlotto', 'service_type' => 'betting', 'code' => 'mlotto'],
            ['name' => 'western-lotto', 'service_type' => 'betting', 'code' => 'western-lotto'],
            ['name' => 'hallabet', 'service_type' => 'betting', 'code' => 'hallabet'],
            ['name' => 'green-lotto', 'service_type' => 'betting', 'code' => 'green-lotto'],
            // Electric
            ['name' => 'Eko Electric - EKEDC', 'service_type' => 'electricity', 'code' => 'ekedc'],
            ['name' => 'Ikeja Electric - IKEDC', 'service_type' => 'electricity', 'code' => 'ikedc'],
            ['name' => 'Abuja Electric - AEDC', 'service_type' => 'electricity', 'code' => 'aedc'],
            ['name' => 'Kano Electric - KEDC', 'service_type' => 'electricity', 'code' => 'kedc'],
            ['name' => 'Porthacourt Electric - PHEDC', 'service_type' => 'electricity', 'code' => 'phedc'],
            ['name' => 'Jos Electric - JEDC', 'service_type' => 'electricity', 'code' => 'jedc'],
            ['name' => 'Ibadan Electric - IBEDC', 'service_type' => 'electricity', 'code' => 'ibedc'],
            ['name' => 'Kaduna Elecdtric - KAEDC', 'service_type' => 'electricity', 'code' => 'kaedc'],
            ['name' => 'Enugu Electric - EEDC', 'service_type' => 'electricity', 'code' => 'eedc'],
            ['name' => 'Benin Electric - BEDC', 'service_type' => 'electricity', 'code' => 'bedc'],
            ['name' => 'Yola Electric - YEDC', 'service_type' => 'electricity', 'code' => 'yedc'],
            ['name' => 'Aba Electric - APLE', 'service_type' => 'electricity', 'code' => 'aple'],
            // Exam
            ['name' => 'WAEC registration PIN', 'service_type' => 'exam', 'code' => 'waec-registration'],
            ['name' => 'WAEC checker PIN', 'service_type' => 'exam', 'code' => 'waec-checker'],
            ['name' => 'UTME', 'service_type' => 'exam', 'code' => 'utme'],
            ['name' => 'Direct Entry (DE)', 'service_type' => 'exam', 'code' => 'de'],
            ['name' => 'NECO e-VERIFICATION PIN', 'service_type' => 'exam', 'code' => 'neco-verify'],
        ];

        $stmt = $pdo->prepare("INSERT INTO service_providers (name, service_type, code) VALUES (?, ?, ?)");
        foreach ($providers as $provider) {
            $stmt->execute([$provider['name'], $provider['service_type'], $provider['code']]);
        }
